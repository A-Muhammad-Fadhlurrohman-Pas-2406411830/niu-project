...
-whe every possibility in the code has already been tested
...
2
if nthe new code has the same setup procedures and instance variables, it doesnt obey the "Don't Repeat Yourself"
